...
function App() {
  ...
  return (
    <div className="min-h-screen top-2 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-300">
      {/* ===== NAVBAR ===== */}
      <nav className="sticky  z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800 transition-all duration-300">
      ...
      <main>
        ...
        <section
          data-aos="fade-up"
          className="relative overflow-hidden bg-linear-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 py-5"
        >
          <div className="absolute  bg-grid-pattern opacity-5 dark:opacity-10"></div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="relative">
                <div className="absolute top-0 left-8 w-0.5 h-full bg-linear-to-b from-green-500 to-transparent"></div>
              ...
              {/* Recruiter Flow */}
              <div className="relative">
                <div className="absolute top-0 left-8 w-0.5 h-full bg-linear-to-b from-blue-500 to-transparent"></div>
        ...
        {/* ===== FINAL CTA SECTION ===== */}
        <section className="py-24 bg-linear-to-br from-blue-600 via-indigo-600 to-purple-700 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => setUserType("candidate")}
                className="group px-8 py-4 bg-white text-blue-600 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all duration-300 shadow-2xl transform hover:-translate-y-1"
              >
                <span className="flex items-center">
              ...
              <button
                onClick={() => setUserType("recruiter")}
                className="group px-8 py-4 bg-transparent text-white border-2 border-white rounded-xl font-semibold text-lg hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:-translate-y-1"
              >
                <span className="flex items-center">
                  Start Hiring Today
                  <svg
            ...
            <p className="text-blue-100 mt-8 text-sm">
              No credit card required • Free 14-day trial for recruiters
            </p>
          </div>
        </section>
      </main>

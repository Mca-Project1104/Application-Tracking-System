...
const CandidateDashboard = () => {
  const [recommandedjob, setRecommandedJob] = useState([]);
  ...
  if (candidateLoading || user === null || !applications) {
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg hover:shadow-lg transition-all duration-200">
          <div className="px-4 py-5 sm:p-6">
            ...
            <div className="mt-4 space-y-2">
              {candidate?.ats_score > 0 &&
                resumeSuggestion.map((suggest, idx) => (
              ...
              jobs.slice(0, 2).map((job, index) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                    ...
                    <div className="flex sm:flex-col items-center space-y-5 sm:items-end gap-3 sm:gap-2 shrink-0">
                      <button

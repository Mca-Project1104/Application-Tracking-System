...
const Login = ({ setIsAuthenticated, setUserRole }) => {
  ...
  return (
    <div className="min-h-screen p-6  flex bg-white dark:bg-black">
      {/* Left Side - Login Form */}
      <div className="flex-1  flex  dark:bg-white/80 rounded-l flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <h2 className="text-2xl font-bold text-gray-900">HireFlow</h2>
      ...
      <div className="hidden lg:block relative w-0 flex-1">
        <img
          className="absolute rounded-r-2xl   inset-0 h-full w-full object-cover"
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center p-12 text-center">
          ...
          <p className="text-xl text-indigo-100 max-w-lg">
            ...
            efficiently. Manage applications, track interviews, and collaborate
          ...
          <div className="mt-8 flex space-x-4">
            ...
            <div className="flex items-center text-white">
              ...
              <span>Collaborative Hiring</span>
            </div>
          </div>
